...
public class PractiseTask3 {
    ...
    3. Cydeo
		...
		5. declare an array variable named AllStudents and assign batch24Groups & batch25Groups to the indexes of AllStudents
    ...
    public static void main(String[] args) {
        ...
        int[] batch25Groups = {batch25Group1.length,batch25Group2.length,batch25Group3.length};
        ...
        int[] batch24Groups = {batch24Group1.length,batch24Group2.length,batch24Group3.length};
        System.out.println(Arrays.toString(batch24Groups));

        String[][][] allStudents ={batch24,batch25};
